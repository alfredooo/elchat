...
/**
 * Return a `Collection` of all js defined.
 *
 * @return {Collection}
 * @api public
 */
...
/**
 * Return js with route paths matching `path`.
 *
 * @param {String} method
 * @param {String} path
 * @return {Collection}
...
/**
 * Return js with regexps that match the given `url`.
 *
 * @param {String} method
 * @param {String} url
 * @return {Collection}
...
/**
 * Find js based on the return value of `fn`
...
Router.prototype._route = function(method, path, callbacks){
  ...
  var route = new Route(method, path, callbacks, {
      sensitive: app.enabled('case sensitive js')
